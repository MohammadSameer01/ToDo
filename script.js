...
// Get the container-lists element
var containerLists = document.querySelector(".container-lists");

// Add a click event listener to the container-lists
containerLists.addEventListener("click", function (event) {
    // Check if the clicked element is a direct child of container-lists
    if (event.target.parentNode === containerLists) {
        // Show the modal
